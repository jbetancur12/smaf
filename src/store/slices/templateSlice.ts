...
export const doCreateTemplate = createAsyncThunk(
  'templates/create',
  async (templateData: TemplateData) => createTemplate(templateData)
)

export const doUpdateTemplate = createAsyncThunk(
  'templates/update',
  async ({ id, data }: { id: string | undefined; data: TemplateData }) =>
    updateTemplate(id, data)
)

export const doDeleteTemplate = createAsyncThunk(
  'templates/delete',
...
export const retrieveTemplate = createAsyncThunk(
  'templates/retrieveOne',
  async (templateId: any) => getTemplate(templateId)
)
