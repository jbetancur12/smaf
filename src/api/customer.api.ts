...
export const createCustomer = (
  ...
  httpApi
    .post<undefined>('api/customers', { ...customerData })
    .then(({ data }) => data)
...
export const updateCustomer = (
  ...
  httpApi
    .put<CustomerDataResponse>(`api/customers/${id}`, { ...customerData })
    .then(({ data }) => data)
...
export const deleteCustomer = (
  ...
  httpApi
    .delete<CustomerDataResponse>(`api/customers/${customerId}`)
    .then(({ data }) => data)
...
export const getCustomer = (
  ...
  httpApi
    .get<CustomerDataResponse>(`api/customers/${customerId}`)
    .then(({ data }) => data)
